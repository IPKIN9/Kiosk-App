...
export default {
  ...
  pay(payload){
    return Api(AuthCheck.getLocalSetup('RENDERER_VITE_GATE_SERVICE_URL')).post(`${endPoint}/progress`, payload, AuthCheck.tokenConfig())
  },
  validate(id){
    return Api(AuthCheck.getLocalSetup('RENDERER_VITE_GATE_SERVICE_URL')).get(`${endPoint}/validate/${id}`, AuthCheck.tokenConfig())
  },
  detail(id) {
    return Api(AuthCheck.getLocalSetup('RENDERER_VITE_GATE_SERVICE_URL')).get(`${endPoint}/${id}`, AuthCheck.tokenConfig())
  },
  cancelOrder(id){
